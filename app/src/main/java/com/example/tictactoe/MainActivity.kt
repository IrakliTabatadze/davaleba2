...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun check() {
        ...
        if (winnerPlayer != 0) {
            ...
            if (winnerPlayer == 1) {
                player1Score += 1
                player1Score.toString() = "Player1:${player1Score.toString()}"
                ...
                player2Score += 1
                player2Score.toString() = "Player1:${player2Score.toString()}"
    ...
    private fun reset(buttonNumber: Int, clickedView: Button){
